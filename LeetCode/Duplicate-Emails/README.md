...
### Approach 1: Virtual Inline Aggregation via Subquery 🌟 [Implemented]
* **File Reference**: `solution_01_subquery.sql`
...
### Approach 2: Direct Group Aggregation with HAVING
* **File Reference**: `solution_02_having_clause.sql`
